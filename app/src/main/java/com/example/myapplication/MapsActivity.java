...
////     * we just add a marker near GSclg, Australia.
...
////        mMap = googleMap;
////
////        // Add a marker in GSclg and move the camera
////        LatLng GSclg = new LatLng(-34, 151);
////        mMap.addMarker(new MarkerOptions().position(GSclg).title("Marker in GSclg"));
////        mMap.moveCamera(CameraUpdateFactory.newLatLng(GSclg));
////    }
//    @Override
...
private ActivityMapsBinding binding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        // Add a marker in GSclg and move the camera
        LatLng clg = new LatLng(21, 79);
        mMap.addMarker(new MarkerOptions().position(clg).title("Marker in clg"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(clg));
    }
}